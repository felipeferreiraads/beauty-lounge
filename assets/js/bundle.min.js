...
var _extractDataOptions = __webpack_require__(3);

var _extractDataOptions2 = _interopRequireDefault(_extractDataOptions);

var _customAlert = __webpack_require__(13);
...
var Form = function () {
  function Form(form) {
    ...
    var dataOptions = (0, _extractDataOptions2.default)(form, 'form');

    this.$form = (0, _jquery2.default)(form);
    this.options = _jquery2.default.extend({}, Form.defaults, options, dataOptions);
    this.pending = false;
  ...
  _createClass(Form, [{
    ...
    value: function disableSubmitButton() {
      this.$submitButton.attr('disabled', true).html(this.options.disabledButtonHtml);
    }
  }, {
    key: 'enableSubmitButton',
    value: function enableSubmitButton() {
      this.$submitButton.removeAttr('disabled').html(this.submitButtonHtml);
    }
  }, {
    key: 'performAjaxRequest',
    value: function performAjaxRequest() {
      var _this = this;

      var feedbackHandler = this.options.feedbackHandler;
      ...
      _jquery2.default.ajax({
        ...
        data: data,
        dataType: 'json'
      }).done(feedbackHandler).fail(function (err) {
        feedbackHandler({ message: 'Erro ao enviar dados!' });
      }).always(function () {
        _this.pending = false;

        if (_this.options.disableButtonOnSubmit) {
...
Form.defaults = {
  ...
  feedbackHandler: function feedbackHandler(feedback) {
    var type = feedback.success ? 'success' : 'error';

    var title = feedback.title || '';
    var text = feedback.message;

    (0, _customAlert2.default)({ type: type, title: title, text: text });
  }
};
...
(0, _jquery2.default)('.js-form').each(function () {
  var form = new Form(this);
  (0, _jquery2.default)(this).data('form', form);
});
...
var setKeypathValue = __webpack_require__(11)
...
var noCase = __webpack_require__(6)
...
var lowerCase = __webpack_require__(7)

var NON_WORD_REGEXP = __webpack_require__(8)
var CAMEL_CASE_REGEXP = __webpack_require__(9)
var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(10)
...
var _sweetalert = __webpack_require__(14);
...
/**
 * Translate the default messages.
 */
...
_jquery2.default.extend(_jquery2.default.validator.messages, {
  ...
  maxlength: _jquery2.default.validator.format('Por favor, forne&ccedil;a n&atilde;o mais que {0} caracteres.'),
  minlength: _jquery2.default.validator.format('Por favor, forne&ccedil;a ao menos {0} caracteres.'),
  rangelength: _jquery2.default.validator.format('Por favor, forne&ccedil;a um valor entre {0} e {1} caracteres de comprimento.'),
  range: _jquery2.default.validator.format('Por favor, forne&ccedil;a um valor entre {0} e {1}.'),
  max: _jquery2.default.validator.format('Por favor, forne&ccedil;a um valor menor ou igual a {0}.'),
  min: _jquery2.default.validator.format('Por favor, forne&ccedil;a um valor maior ou igual a {0}.'),
  step: _jquery2.default.validator.format('Por favor, forne&ccedil;a um valor m&acute;tiplo de {0}.'),

  // Metodos Adicionais
  maxWords: _jquery2.default.validator.format('Por favor, forne&ccedil;a com {0} palavras ou menos.'),
  minWords: _jquery2.default.validator.format('Por favor, forne&ccedil;a pelo menos {0} palavras.'),
  rangeWords: _jquery2.default.validator.format('Por favor, forne&ccedil;a entre {0} e {1} palavras.'),
  ...
  require_from_group: _jquery2.default.validator.format('Por favor, forne&ccedil;a pelo menos {0} destes campos.'),
  skip_or_fill_minimum: _jquery2.default.validator.format('Por favor, optar entre ignorar esses campos ou preencher pelo menos {0} deles.'),
  stateUS: 'Por favor, forne&ccedil;a um estado v&aacute;lido.',
  strippedminlength: _jquery2.default.validator.format('Por favor, forne&ccedil;a pelo menos {0} caracteres.'),
